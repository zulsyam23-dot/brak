...
impl PyO3Generator {
    ...
    pub fn generate_project(module_name: &str, bindings: &[FfiBinding], lib_name: &str) -> String {
        ...
        out.push_str("cc = \"1\"\n");
        out.push_str("# The Brak shared library is linked automatically\n");

        // Write separator before source code
        out.push_str("// --- src/lib.rs ---\n");
        out.push_str("// Generated by Brak Polyglot — Python bindings for ");
        out.push_str(lib_name);
        out.push_str("\n\n");
        out.push_str(&Self::generate_string(module_name, bindings));
        out
    }
